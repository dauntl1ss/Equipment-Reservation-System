...
{
    public partial class UserEquipment3 : Form
    {
        public UserEquipment3()
        {
            InitializeComponent();
        }
        ...
        {
            this.Hide();
            UserEquipment2 userEquipment2 = new UserEquipment2();
            userEquipment2.Show();
        }

        private void UserEquipment3_Load(object sender, EventArgs e)
        {
            try
            {
